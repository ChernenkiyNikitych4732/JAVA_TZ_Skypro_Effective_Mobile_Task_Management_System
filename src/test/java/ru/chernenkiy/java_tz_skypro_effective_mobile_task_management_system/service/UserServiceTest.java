...
import ru.chernenkiy.java_tz_skypro_effective_mobile_task_management_system.dto.TaskRequest;
import ru.chernenkiy.java_tz_skypro_effective_mobile_task_management_system.dto.TaskUpdateRequest;
import ru.chernenkiy.java_tz_skypro_effective_mobile_task_management_system.dto.UpdateStatusRequest;
...
import ru.chernenkiy.java_tz_skypro_effective_mobile_task_management_system.exception.PerformerNotFound;
import ru.chernenkiy.java_tz_skypro_effective_mobile_task_management_system.exception.TaskAlreadyExistException;
import ru.chernenkiy.java_tz_skypro_effective_mobile_task_management_system.exception.TaskNotFoundException;
import ru.chernenkiy.java_tz_skypro_effective_mobile_task_management_system.repository.TaskRepository;
import ru.chernenkiy.java_tz_skypro_effective_mobile_task_management_system.repository.UserRepository;
import ru.chernenkiy.java_tz_skypro_effective_mobile_task_management_system.security.JwtCore;
...
@ExtendWith(MockitoExtension.class)
 class UserServiceTest {
    ...
    void testAddPerformer_PerformerNotFound() {
        ...
        PerformerNotFound thrown = assertThrows(PerformerNotFound.class, () -> userService.addPerformer(taskId, performerId));
    ...
    void testGetUserTasksByIdWithFilters_UserNotFound() {
        ...
        UsernameNotFoundException thrown = assertThrows(UsernameNotFoundException.class, () -> userService.getUserTasksByIdWithFilters(userId, pageable, status, priority));
