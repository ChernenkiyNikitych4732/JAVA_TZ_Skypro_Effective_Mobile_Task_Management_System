...
public class ControllerExceptionHandler {
  ...
  public ResponseError handleNullEnumArgument(
    ...
    return new ResponseError(
        HttpStatus.BAD_REQUEST, ex.getBindingResult().getFieldError().getDefaultMessage());
  }
  ...
  public ResponseError handleIllegalEnumArgument(
    ...
    } else acceptedValues = " Parameter cannot be EMPTY";
  ...
  public ResponseError handleSpringAccessDeniedException(
      org.springframework.security.access.AccessDeniedException ex, WebRequest request) {
    String errorMessage = "Error 403: Forbidden - " + ex.getMessage();
    log.error(errorMessage);
    return new ResponseError(
        HttpStatus.FORBIDDEN,
        ex.getMessage() + " (Be sure you have the required role for this resource)");
  }
